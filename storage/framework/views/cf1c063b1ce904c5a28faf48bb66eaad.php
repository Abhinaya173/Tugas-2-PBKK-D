...
<body>
    <form action="<?php echo e(route('simpan-formulir')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <!-- Field 1 -->
...
</html><?php /**PATH C:\Users\ABHINAYA\OneDrive\Dokumen\Kuliah\Semester 5\PBKK\Tugas\Tugas2\resources\views/formulir.blade.php ENDPATH**/ ?>